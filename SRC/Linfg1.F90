...
integer(4),INTENT(IN)  :: mode        !  1: do the evaluation:
...
integer(4)        :: i,npts,nhh,nck,k1,k2
EXTERNAL          :: funcs
LOGICAL           :: ok
real(rn)          :: wi
real(rn)          :: zfact,cov
...
integer(4)        :: gwlist(1),n1,n2,nr,j,kqt,i_arr(numd/5),nhh_arr(numd/5)
LOGICAL           :: prout
!-----------------------------------------------------------------------
...
integer(4), INTENT(IN)      :: n             ! number of measured values (x values, <= nc)
integer(4), INTENT(IN)      :: nc            ! physical dim of covy1
real(rn), INTENT(IN)        :: x(n)          ! vector of x values
real(rn), INTENT(IN)        :: covy1(nc,nc)  ! covariance matrix of the x values
integer(4), INTENT(IN)      :: nr            ! number of parameters to be fitted
