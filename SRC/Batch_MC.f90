...
USE UR_Variables,     only: fname,fnameMCB,mcbatch,project_loadw,sListSeparator,UR_AUTO_output_path, &
                            work_path
...
! use PLP,               only: ProcessLoadPro_new
...
integer(4)              :: i,i1,i2,i3,ios,kcmx(10),neg
integer(4)              :: kfi,kmeth,fmeth(10),km,kTLSQ
INTEGER(4)              :: zt1(9)
