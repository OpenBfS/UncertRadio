...
module gtk_hl_tree
  ...
  private :: hl_gtk_list_tree_add_column, &
       & hl_gtk_list_tree_set_cell_data_func, &
  ...
  public  :: hl_gtk_list_tree_get_gvalue,hl_gtk_list_tree_set_gvalue           ! GK
...
contains
  ...
  subroutine hl_gtk_listn_set_cell(list, row, col, &
    ...
    call g_value_unset(val)       ! added 21.9.2020  saves a lot of Glib output GK
  ...
  subroutine hl_gtk_listn_get_cell(list, row, col, &
    ...
    ! if (valid == FALSE) return
        if (valid == FALSE) then
          if(present(svalue)) svalue = 'invalid'                             ! 25.5.2017  GK
          return
        end if
    ...
    call g_value_unset(val)       ! added 21.9.2020   saves a lot of GLIB output
