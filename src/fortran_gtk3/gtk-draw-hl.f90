...
contains
 ...
 !//      call g_signal_connect(plota, "size-allocate"//c_null_char, &          !// GK
...
!!!!!!!!!!!!!!!!!!!!!!    call hl_gtk_drawing_area_resize(area, copy=.true.)  ! GK (14.8.2022); disabled this line
...
!//  GK (14.8.2022): removed the next 3 lines,because they made the area narrower than necessary
