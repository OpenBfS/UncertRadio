...
integer(4),INTENT(OUT)    :: ikenn

integer(4)         :: kxy,i,kksv
...
integer(4)          :: kxy,kmax,i11,resp,i11max
...
integer(4)            :: nvsum,kxy,i,nplus,nvor,ix
...
integer(4),intent(in)          :: ifx
character(len=15),intent(out)  :: buthelp

integer(4)                 :: ios,i,nfd,imax
