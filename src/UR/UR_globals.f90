...
module ur_general_globals
    ...
    character(:),allocatable :: prefix_path           ! root/install directory e.g. /usr/ or .install, read only
    character(:),allocatable :: data_path             ! data directory 'share/UncertRadio, read only
    character(:),allocatable :: docs_path             ! = 'share/doc/UncertRadio', read only
