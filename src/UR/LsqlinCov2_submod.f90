...
integer(4),INTENT(IN)    :: nred          ! number of parameters actually to be fitted
...
! real(rn)          :: yvar2(nred)
integer(4)        :: kk,ir,kr,messk,messk2,irun
...
integer(4)            :: maxiter,iteration,kfitmeth2,ipr,npar,mfit,kqt,n1
