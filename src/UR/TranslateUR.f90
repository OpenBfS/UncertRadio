...
subroutine TranslateUR()
    ...
    call WDPutTreeViewColumnLabel('treeview5', 10, T('u(CountRate)')//char(13)//'(BG)')
    call WDPutTreeViewColumnLabel('treeview5', 11, T('CountRate')//char(13)//'(net)')
    call WDPutTreeViewColumnLabel('treeview5', 12, T('u(CountRate)')//char(13)//'(net)')
    ...
    call WDPutLabelString('TRLBMCDT', T('Decision threshold (DT):'))
    call WDPutLabelString('TRLBMCdl', T('Detection limit (DL):'))
    ...
    call WDPutLabelString('TRlabDT', T('Decision threshold (DT):'))
    call WDPutLabelString('TRlabDL', T('Detection limit (DL):'))
    ...
    call WDPutLabelString('TRLBdtMT', T('Decision threshold (DT):'))
    call WDPutLabelString('TRLBbfMT', T('Bayes factor:'))
    call gtk_window_set_title(idpt('dialog_LoadPro'), T('Project load:') // c_null_char)

    str1 = T("The program is loading the project file and does all calculations subsequently.") // char(13) &
       // T("This may take few seconds!") // char(13)   &
